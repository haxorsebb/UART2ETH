...
|Channel 2 TX |GP22 |PIO |UART Channel 2 transmit (reserved, disabled)
|Channel 2 RX |GP23 |PIO |UART Channel 2 receive (reserved, disabled)
|Channel 3 TX |GP24 |PIO |UART Channel 3 transmit (reserved, disabled)
|Channel 3 RX |GP25 |PIO |UART Channel 3 receive (reserved, disabled)
...
|Channel 2 |PIO |GP22 |GP23 |230400 |**Disabled** (future expansion)
|Channel 3 |PIO |GP24 |GP25 |230400 |**Disabled** (future expansion)
|===
...
- **Channel 2**: Independent pins GP22/GP23 ready for implementation
- **Channel 3**: Independent pins GP24/GP25 ready for implementation
