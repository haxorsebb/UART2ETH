...
flash write_image erase build/uart2eth_ota.bin 0x10002000
verify_image build/uart2eth_ota.bin 0x10002000
...
echo "Erasing factory default partition..."
flash erase_address 0x1017E000 0x2000
echo "Erasing data partition..."
flash erase_address 0x10180000 0x80000
