...
typedef enum {
    ...
    LOG_EVENT_FLASH_WRITE_SUCCESS,
    LOG_EVENT_FLASH_WRITE_FAILED,
    LOG_EVENT_FLASH_WRITE_SECTOR_UPDATE,
    LOG_EVENT_FLASH_CHKSUM,
    ...
    LOG_EVENT_FLASH_PROGRAM,
    LOG_EVENT_FLASH_PROGRAM_FAILED,
