...
typedef enum {
    ...
    LOG_EVENT_FLASH_PAGE_SCAN,
    LOG_EVENT_FLASH_PAGE_NUMBER,
    LOG_EVENT_FLASH_PAGE_REVISION,
    LOG_EVENT_FLASH_PAGE_INVALID,
    LOG_EVENT_FLASH_BEST_PAGE_NUMBER,
    LOG_EVENT_FLASH_BEST_PAGE_REV,
